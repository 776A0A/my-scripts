...
var Prompt = /** @class */ (function (_super) {
    ...
    Prompt.prototype.exec = function () {
    ...
    Prompt.prototype.injectQuestion = function (question) {
        var _this = this
        ...
        return {
            add: function (_question) {
                return _this.injectQuestion(_question)
            },
        }
    }
    ...
    Prompt.prototype.has = function (question) {
        return this.questions.some(function (_a) {
            var name = _a.name
